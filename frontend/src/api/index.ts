...
export const confirmDone = (wordIds: number[], totalQuestions = 0, correctAnswers = 0, spellingCorrect = 0, createGroup = true, imprints = 0) =>
  api.post('/learning/confirm', { word_ids: wordIds, total_questions: totalQuestions, correct_answers: correctAnswers, spelling_correct: spellingCorrect, create_group: createGroup, imprints });
